      ...
      >
        <div class="relative flex flex-col bg-white shadow-lg rounded-xl">
          ...
          <div class="p-4 overflow-y-auto text-center sm:p-10">
            ...
            <label class="flex flex-col items-start justify-center mt-2">
            ...
            <div class="grid mt-6 gap-y-2">
              <button
                type="button"
                class="py-2.5 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border hover:text-white hover:bg-red-500 disabled:opacity-50 disabled:pointer-events-none"
                data-hs-overlay="#hs-sign-out-alert-small-window"
              >
                Conferma
              </button>
